...
function PlannerSection() {
  ...
  return (
    <section ref={sectionRef} className="fesecte-section bg-gradient-to-b from-[#fffaf0] via-[#fff3e6] to-[#f7e7d7] py-28 overflow-hidden">
      <div className="mx-auto max-w-4xl px-4 text-center">
        <span className="text-xs font-black tracking-[0.25em] text-[#b57a2d] uppercase">Certified Local Guides</span>
        <h2 className="mt-3 text-4xl md:text-5xl font-black text-[#3f2b1a]">Book Your Guide</h2>
        <div className="mx-auto mt-5 h-1.5 w-24 rounded-full bg-[#b57a2d]" />
        <p className="mt-7 text-base md:text-lg leading-8 text-[#5b4423] max-w-2xl mx-auto font-medium">
      ...
      <div className="mx-auto max-w-7xl px-6 mt-16">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div ref={contentRef} className="text-center lg:text-left">
            ...
            <Link to="/booking" className="mt-12 inline-flex rounded-2xl bg-[#b57a2d] px-8 py-3.5 text-base font-bold text-white shadow-xl shadow-amber-900/20 transition-all duration-300 hover:bg-[#966321] hover:scale-105 active:scale-95">
              Book a Guide Now →
            </Link>
          </div>
        </div>
