...
function AttractionsPage() {
  ...
  useSEO({
    ...
    description:
      "Browse the ultimate guide to Egypt's temples, Giza pyramids, historical museums, and cultural heritage landmarks.",
  });
    ...
    >
      <section className="mx-auto max-w-6xl">
        <div className="text-center mb-10">
          ...
          <h1 className="mt-2 text-4xl font-black text-[#3f2b1a] md:text-6xl tracking-tight">
            All Attractions
          </h1>
          <p className="mt-3 text-base text-[#685743] max-w-xl mx-auto font-medium">
            Explore ancient wonders, temples, and historical landmarks across
            Egypt.
          </p>
        </div>
        ...
        {filtered.length === 0 && (
          <div className="py-20 text-center text-stone-500">
            ...
            <button
              ...
              className="mt-4 rounded-full bg-[#b57a2d] px-6 py-2 text-xs font-bold text-white shadow-md hover:bg-[#8f5d1e] transition cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
