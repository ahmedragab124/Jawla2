...
function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative overflow-hidden bg-linear-to-b from-[#2a1d13] via-[#20150d] to-[#160d07] text-white/80 pt-16 pb-8 border-t-2 border-[#b57a2d]/40"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs leading-6 text-white/70 font-medium max-w-xs">
              Explore Egypt's pharaonic wonders, book certified Egyptologist
              guides, and generate custom AI itineraries for an unforgettable
              journey.
            </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-white/50">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/attractions" className="hover:text-amber-300 transition">
              Attractions
            </Link>
          </div>
        </div>
