...
function Navbar() {
  ...
  return (
    <nav
      ref={navRef}
      className="sticky top-0 z-50 transition-all duration-300 px-6 py-4 nnv text-white"
    >
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div ref={linksRef} className="hidden md:flex gap-8 items-center">
          <Link
            to="/destinations"
            className="text-white font-medium hover:text-amber-300 transition duration-200 cursor-pointer py-1"
          >
            Destinations
          </Link>
          <Link
        ...
        <div ref={actionsRef} className="hidden md:flex items-center gap-6">
          <Link
            to="/booking"
            className="bg-[#b57a2d] text-white px-6 py-2.5 rounded-full hover:bg-[#9b6525] hover:scale-105 transition duration-300 font-semibold cursor-pointer shadow-lg"
          >
            Book Now
          </Link>
          <AuthNavAction />
